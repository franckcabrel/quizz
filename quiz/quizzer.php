...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <a href='deco.php'> logout </a>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Quizzeur</a>
 ...
 <li class="franck">   <div class="card" style="width: 18rem; margin-left: 255px;">
        <img src="https://www.lenounou.fr/wp-content/uploads/2020/11/quizz.jpg" class="card-img-top">
        <div class="card-body">
          ...
          <a href="list_quiz.php" class="btn btn-primary stretched-link">voir plus</a>
        </div>
        </div>
</li>
...
<li class="franck">     <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="list_user.php" class="btn btn-primary stretched-link">voir plus</a>
        </div>
      </div>
</li>
