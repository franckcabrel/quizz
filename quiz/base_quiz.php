...
if(isset($_POST['email']) && isset($_POST['password']))
{
    ...
    if( $username !== "" && $password !== "")
    {
        ...
        {
           header('Location: connexion_quiz.php?erreur=1'); // utilisateur ou mot de passe incorrect
        }
    }
    else
    {
       header('Location: connexion_quiz.php?erreur=2'); // utilisateur ou mot de passe vide
    }
}
else
{
