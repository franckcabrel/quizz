...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
  <div class="container-fluid">
    ...
    <center>
        <h1 style="font-family: script;" > LISTE DES QUIZZEURS</h1> <br>
    </center>
...
<tr>
    ...
    <tr>
       <?php while ($quiz = $result->fetch_array()) {
        ...
        <input type="button" style="margin-left: 3%;" value="Ajouter" onclick="window.location.href='inscriptionq.php'"></button><br>
</body>
</html>